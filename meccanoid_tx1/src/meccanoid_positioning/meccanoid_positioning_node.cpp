...
meccanoid_tx1::hedge_pos hedge_pos_msg;// message for publishing to ROS topic
...
int main(int argc, char **argv)
{
  ...
  ros::Publisher hedge_pos_publisher = n.advertise<meccanoid_tx1::hedge_pos>("/position", 1000);
