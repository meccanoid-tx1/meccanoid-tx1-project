...
/*
/ Creates a meccanoid servo controller struct
*/
struct MeccanoidServoControl* createMeccanoidServoControl (){
    struct MeccanoidServoControl* controller = malloc(sizeof(struct MeccanoidServoControl));
    if (controller){
        controller->active = 1;
        controller->numServos = 2;
    }else{ 
...
/*
/ Destroys a meccanoid servo controller struct
*/ 
void destroyMeccanoidServoControl(struct MeccanoidServoControl* controller){
    free(controller);
}

/*
/ starts meccanoid servo logic
*/
void activateMeccanoidServoControl(struct MeccanoidServoControl* controller){
    //TODO: set gpio pins in servo control mode
    //TODO: init control logic
    controller->active = 1;
}

/*
/ stops meccanoid servo logic
*/
void deactivateMeccanoidServoControl(struct MeccanoidServoControl* controller){
