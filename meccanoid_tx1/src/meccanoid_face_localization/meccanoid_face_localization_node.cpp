#include <ros/ros.h>
#include "meccanoid_face_localization/meccanoid_servo_control.h"
...
class MeccanoidFaceLocalization{
  public:
    ...
    */
    void faceLocalizationCallback(const meccanoid_tx1::meccanoid_face_locationConstPtr& msg){
  ...
  private:
    ...
    meccanoid_tx1::meccanoid_face_location face_location_msg;
};
