...
using meccanoid_face_localization::meccanoid_face_location;
  ...
  public:
    ...
    */
    MeccanoidFaceDetector(ros::Publisher pub, bool showIm){
        ...
        showImages = showIm;
        if (!faceLocationClassifier.load("/usr/share/opencv/haarcascades/haarcascade_frontalface_alt2.xml")){
...
int main(int argc, char **argv)
{
    ...
    image_transport::Subscriber faceLocationSubscriber = it.subscribe("/v4l/camera/image_raw", 1,
