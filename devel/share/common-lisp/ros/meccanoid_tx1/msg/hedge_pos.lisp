...
(cl:defmethod cl:initialize-instance :after ((m <hedge_pos>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'hedge_pos)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name meccanoid_tx1-msg:<hedge_pos> is deprecated: use meccanoid_tx1-msg:hedge_pos instead.")))

(cl:ensure-generic-function 'timestamp_ms-val :lambda-list '(m))
(cl:defmethod timestamp_ms-val ((m <hedge_pos>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader meccanoid_tx1-msg:timestamp_ms-val is deprecated.  Use meccanoid_tx1-msg:timestamp_ms instead.")
  (timestamp_ms m))

(cl:ensure-generic-function 'x_m-val :lambda-list '(m))
(cl:defmethod x_m-val ((m <hedge_pos>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader meccanoid_tx1-msg:x_m-val is deprecated.  Use meccanoid_tx1-msg:x_m instead.")
  (x_m m))

(cl:ensure-generic-function 'y_m-val :lambda-list '(m))
(cl:defmethod y_m-val ((m <hedge_pos>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader meccanoid_tx1-msg:y_m-val is deprecated.  Use meccanoid_tx1-msg:y_m instead.")
  (y_m m))

(cl:ensure-generic-function 'z_m-val :lambda-list '(m))
(cl:defmethod z_m-val ((m <hedge_pos>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader meccanoid_tx1-msg:z_m-val is deprecated.  Use meccanoid_tx1-msg:z_m instead.")
  (z_m m))

(cl:ensure-generic-function 'flags-val :lambda-list '(m))
(cl:defmethod flags-val ((m <hedge_pos>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader meccanoid_tx1-msg:flags-val is deprecated.  Use meccanoid_tx1-msg:flags instead.")
  (flags m))
