...
if(NOT "/home/jesper/Documents/Programming/Kandidat/devel/include " STREQUAL " ")
  set(meccanoid_tx1_INCLUDE_DIRS "")
  set(_include_dirs "/home/jesper/Documents/Programming/Kandidat/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'meccanoid_tx1' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jesper/Documents/Programming/Kandidat/src/meccanoid_tx1/${idir}'.  Ask the maintainer 'None <this.package.is@not.maintained>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/jesper/Documents/Programming/Kandidat/devel/lib;/opt/ros/kinetic/lib)
