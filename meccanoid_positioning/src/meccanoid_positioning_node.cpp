...
meccanoid_positioning::hedge_pos hedge_pos_msg;// message for publishing to ROS topic
...
{
  // initialize ROS node
  ros::init(argc, argv, "meccanoid_positioning");
  ...
  ros::Publisher hedge_pos_publisher = n.advertise<meccanoid_positioning::hedge_pos>("/position", 1000);
